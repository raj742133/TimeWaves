...
#Preview {
    VStack {
        TideRowView(tide: TideData(timestamp: Date(), height: 1.5, type: .high), style: .history)
        TideRowView(tide: TideData(timestamp: Date(), height: 0.5, type: .low), style: .forecast)
    }
} 